...
namespace BracketPipe.Tests
{
  ...
  class PlainTextTests
  {
    ...
    public void Convert_WhenThereAreHtmlLinks_ThenConvertToMarkDownLinks()
    {
      ...
      const string expected = @"So this is a link. Convert it";
    ...
    public void Convert_WhenThereAreMultipleHtmlLinks_ThenConvertThemToMarkDownLinks()
    {
      ...
      const string expected = @"So this is a link and so is this. Convert them";
    ...
    public void Convert_WhenThereAreEmptyLinks_ThenRemoveThemFromResult()
    {
      ...
      const string expected = @"So this is  and so is this. Convert them";
...
Convert it!";
    ...
    public void Convert_WhenThereAreImgTags_ThenReplaceWithMarkdownImage()
    {
      ...
      const string expected = @"This code is with and image Convert it!";
    ...
    public void Convert_WhenThereAreImgTagsWithoutATitle_ThenReplaceWithMarkdownImage()
    {
      ...
      const string expected = @"This code is with an image Convert it!";
...
- Building Web Apps with Server-Sent Events - Part 1
...
<body>
  ...
  <p>A paragraph</p>
      ...
      const string expected = @"A paragraph";
      ...
      using (var reader = new HtmlReader(html))
      {
        ...
        {
          new KeyValuePair<string, string>("title", "The HTML5 Herald"),
